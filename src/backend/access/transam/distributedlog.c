...
#define TransactionIdToPage(distribXid) ((distribXid) / (TransactionId) ENTRIES_PER_PAGE)
#define TransactionIdToEntry(distribXid) ((distribXid) % (TransactionId) ENTRIES_PER_PAGE)
#define TransactionIdToSegment(distribXid) ((distribXid) / (ENTRIES_PER_PAGE * SLRU_PAGES_PER_SEGMENT))
